...
Fenetre: 12 jours
Dashboard: https://hego.example.com/grafana/d/correlations
```
...
```bash
# === DOMAINE ===
NEGO_DOMAIN=hego.example.com
NEGO_EMAIL=contact@example.com
...
GF_SERVER_ROOT_URL=https://hego.example.com/grafana
...
ALERT_EMAIL_FROM=nego@example.com
...
curl -sk https://hego.example.com/grafana/api/health | jq .
