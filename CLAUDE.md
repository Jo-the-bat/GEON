...
- Le domaine cible est `geon.example.com` avec un certificat Let's Encrypt
...
GF_SERVER_ROOT_URL=https://geon.example.com/grafana
...
3. TLS via Certbot pour geon.example.com
