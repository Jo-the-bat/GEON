...
be recreated manually in the n8n web UI at `https://hego.example.com/n8n/`.
...
2. Add a **Webhook** node:
   ...
   - Note the generated webhook URL (e.g.,
     `https://hego.example.com/n8n/webhook/correlation-alert`).
...
```bash
N8N_CORRELATION_WEBHOOK_URL=https://hego.example.com/n8n/webhook/correlation-alert
```
