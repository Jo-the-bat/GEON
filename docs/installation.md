...
1. **NEGO_DOMAIN** -- your domain name (e.g., `hego.example.com`)
...
# Test Grafana
curl -sk https://hego.example.com/grafana/api/health | python3 -m json.tool

# Test OpenCTI
curl -sk https://hego.example.com/opencti/health
```
...
1. Open Grafana at `https://hego.example.com/grafana`
...
1. Open n8n at `https://hego.example.com/n8n`
