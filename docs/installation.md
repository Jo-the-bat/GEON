...
1. **HEGO_DOMAIN** -- your domain name (e.g., `hego.example.com`)
...
curl -sk https://hego.example.com/kibana/api/status | python3 -m json.tool
...
1. Open Huginn at `https://hego.example.com/huginn`
