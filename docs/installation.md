...
1. **GEON_DOMAIN** -- your domain name (e.g., `geon.example.com`)
...
# Test Grafana
curl -sk https://geon.example.com/grafana/api/health | python3 -m json.tool

# Test OpenCTI
curl -sk https://geon.example.com/opencti/health
```
...
1. Open Grafana at `https://geon.example.com/grafana`
